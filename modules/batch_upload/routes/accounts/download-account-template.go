...
// func DownloadAccountsTemplate(c *fiber.Ctx) error {
// 	// Open the template file from the assets folder
// 	templatePath := "assets/accounts.xlsx"
...
// 		excelFileName = fmt.Sprintf("Accounts-%d.xlsx", number)
// 		excelFilePath = filepath.Join(desktopPath, excelFileName)
// 		number++
// 	}
...
func DownloadAccountsTemplate(c *fiber.Ctx) error {
	excelFileName := "assets/Accounts.xlsx"
